function goldpricenow() {
    // Define the URL and regex pattern
    var url = 'https://goldpricenow.live/view/black-usd';
    var regexBuy = /<div style="font-size:120px;line-height:1\.1;color: #1d3147;" class="mb-5">(.*?)<\/div>/;
    ...
    for (var retry = 1; retry <= maxRetries; retry++) {
        try {
            ...
            if (matchBuy && matchBuy.length > 1) {
                ...
                appendToColumn('I', 4, new Date());
                appendToColumn('J', 4, matchBuy[1]);
